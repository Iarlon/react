  ...
  return (
    <Container className="py-4">
      ...
      <Row className='g-4 mt-4'>
        <Col md={6}>
          <Card>
            <Card.Img variant='top' src='https://images.unsplash.com/photo-1521790797524-b2497295b8a0' style={{height: '200px', objectFit: 'cover'}}></Card.Img>
        ...
        <Col md={6}>
          <Card>
            <Card.Img variant='top' src='https://images.unsplash.com/photo-1513258496099-48168024aec0' style={{height: '200px', objectFit: 'cover'}}></Card.Img>
            <Card.Body className='text-center'>
              <Card.Title>Compromisso com a educação</Card.Title>
              <Card.Text>Temos compromisso com a educação de cada aluno</Card.Text>
            </Card.Body>
          </Card>
        </Col>
      </Row>
